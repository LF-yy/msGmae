...
public class 活动控制台1 extends JFrame
{
    ...
    private void initComponents() {
        ...
        this.魔族突袭开关.addActionListener((ActionListener)new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.魔族突袭开关ActionPerformed(evt);
            }
        });
        ...
        this.魔族攻城开关.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.魔族攻城开关ActionPerformed(evt);
            }
        });
        ...
        this.野外通缉开关.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.野外通缉开关ActionPerformed(evt);
            }
        });
        ...
        this.幸运职业开关.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.幸运职业开关ActionPerformed(evt);
            }
        });
        ...
        this.神秘商人开关.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.神秘商人开关ActionPerformed(evt);
            }
        });
        ...
        this.周末倍率开关.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.周末倍率开关ActionPerformed(evt);
            }
        });
        ...
        this.每日送货开关3.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.每日送货开关3ActionPerformed(evt);
            }
        });
        ...
        this.修改钓鱼物品.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.修改钓鱼物品ActionPerformed(evt);
            }
        });
        ...
        this.刷新钓鱼物品.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.刷新钓鱼物品ActionPerformed(evt);
            }
        });
        ...
        this.钓鱼物品代码.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.钓鱼物品代码ActionPerformed(evt);
            }
        });
        ...
        this.新增钓鱼物品.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.新增钓鱼物品ActionPerformed(evt);
            }
        });
        ...
        this.删除钓鱼物品.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.删除钓鱼物品ActionPerformed(evt);
            }
        });
        ...
        this.钓鱼物品序号.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.钓鱼物品序号ActionPerformed(evt);
            }
        });
        ...
        this.刷新野外BOSS刷新时间.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.刷新野外BOSS刷新时间ActionPerformed(evt);
            }
        });
        ...
        this.刷新野外BOSS刷新时间修改.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.刷新野外BOSS刷新时间修改ActionPerformed(evt);
            }
        });
        ...
        this.修改神秘商人.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.修改神秘商人ActionPerformed(evt);
            }
        });
        ...
        this.幸运职业修改.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                活动控制台1.this.幸运职业修改ActionPerformed(evt);
            }
        });
    ...
    private void 刷新周末倍率开关() {
        String 显示 = "";
        final int S = (int)Integer.valueOf(LtMS.ConfigValuesMap.get((Object)"周末倍率开关"));
        if (S <= 0) {
            显示 = "开启";
        }
        else {
    ...
    private void 刷新神秘商人开关() {
        String 显示 = "";
        final int S = (int)Integer.valueOf(LtMS.ConfigValuesMap.get((Object)"神秘商人开关"));
        if (S <= 0) {
            显示 = "开启";
        }
        else {
    ...
    private void 刷新幸运职业开关() {
        String 显示 = "";
        final int S = (int)Integer.valueOf(LtMS.ConfigValuesMap.get((Object)"幸运职业开关"));
        if (S >0) {
            显示 = "开启";
        }
        else {
    ...
    private void 刷新野外通缉开关() {
        String 显示 = "";
        final int S = (int)Integer.valueOf(LtMS.ConfigValuesMap.get((Object)"野外通缉开关"));
        if (S <= 0) {
            显示 = "开启";
        }
        else {
    ...
    private void 刷新魔族突袭开关() {
        String 显示 = "";
        final int S = (int)Integer.valueOf(LtMS.ConfigValuesMap.get((Object)"魔族突袭开关"));
        if (S <= 0) {
            显示 = "开启";
        }
        else {
    ...
    private void 刷新魔族攻城开关() {
        String 显示 = "";
        final int S = (int)Integer.valueOf(LtMS.ConfigValuesMap.get((Object)"魔族攻城开关"));
        if (S <= 0) {
            显示 = "开启";
        }
        else {
    ...
    public void 按键开关(final String a, final int b) {
        final int 检测开关 = (int)Integer.valueOf(LtMS.ConfigValuesMap.get((Object)a));
        PreparedStatement ps = null;
        PreparedStatement ps2 = null;
        ResultSet rs = null;
        if (检测开关 > 0) {
    ...
    public static void main(final String[] args) {
        try {
            ...
            Logger.getLogger(活动控制台1.class.getName()).log(Level.SEVERE, null, (Throwable)ex2);
        }
        catch (IllegalAccessException ex3) {
            Logger.getLogger(活动控制台1.class.getName()).log(Level.SEVERE, null, (Throwable)ex3);
        }
        catch (UnsupportedLookAndFeelException ex4) {
            Logger.getLogger(活动控制台1.class.getName()).log(Level.SEVERE, null, (Throwable)ex4);
        }
