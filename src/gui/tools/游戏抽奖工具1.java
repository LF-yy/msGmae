...
public class 游戏抽奖工具1 extends JFrame
{
    ...
    private void initComponents() {
        ...
        this.刷新游戏抽奖.addActionListener((ActionListener)new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent evt) {
                游戏抽奖工具1.this.刷新游戏抽奖ActionPerformed(evt);
            }
        });
        ...
        this.删除游戏抽奖.addActionListener((ActionListener)new ActionListener() {
            @Override
            public void actionPerformed(final ActionEvent evt) {
                游戏抽奖工具1.this.删除游戏抽奖ActionPerformed(evt);
            }
        });
    ...
    private void 删除游戏抽奖ActionPerformed(final ActionEvent evt) {
        ...
        if (result1) {
            ...
            try {
                ...
                Logger.getLogger(游戏抽奖工具1.class.getName()).log(Level.SEVERE, null, (Throwable)ex);
            }
        }
        else {
