...
con.close();
        ...
        charTable.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                商品折扣.setText(a10);
                每日限购.setText(a11);
                if (null != charTable.getValueAt(i, 12).toString()) {
                    switch (charTable.getValueAt(i, 12).toString()) {
                        case "点券":
                            货币类型.setText("1");
                            break;
                        case "点/抵用券":
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTabbedPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 910, 80));
        ...
        jPanel24.add(商品代码, new org.netbeans.lib.awtextra.AbsoluteConstraints(84, 55, 65, 20));
        ...
        jPanel24.add(商品价格, new org.netbeans.lib.awtextra.AbsoluteConstraints(234, 25, 65, 20));
        ...
        jPanel24.add(商品库存, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 25, 65, 20));

        商品折扣.setFont(new java.awt.Font("幼圆", 0, 12)); // NOI18N
        jPanel24.add(商品折扣, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 25, 65, 20));
        ...
        jPanel24.add(每日限购, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 55, 65, 20));
        ...
        jPanel24.add(货币类型, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 25, 65, 20));
        ...
        charTable.setModel(new DefaultTableModel(
            ...
            new String [] {
                "商品编码", "物品代码", "道具名称", "数量", "价格", "限时/天", "出售状态", "上/下架", "已售出", "库存", "反馈/%", "每日限购", "货币类型"
            }
        ) {
    ...
    private void 修改ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_修改ActionPerformed
        ...
        try (Connection con = DBConPool.getInstance().getDataSource().getConnection()) {
            ...
            if (rs.next()) {
                ...
                PreparedStatement period = con.prepareStatement(sqlString3);
                ...
                PreparedStatement count = con.prepareStatement(sqlString5);
                ...
                PreparedStatement discount_price = con.prepareStatement(sqlString6);
                ...
                PreparedStatement mark = con.prepareStatement(sqlString7);
