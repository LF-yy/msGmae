...
public class 账号管理工具 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        账号信息.setModel(new DefaultTableModel(
            new Object [][] {
            ...
            Class[] types = new Class [] {
                Object.class, Object.class, Object.class, Object.class, Object.class, Object.class, Object.class, Object.class, Object.class, String.class, Object.class
            };
        ...
        jTabbedPane8.addTab("账号管理", new ImageIcon(getClass().getResource("/gui/1.png")), jPanel23); // NOI18N
        ...
        角色信息.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        jTabbedPane8.addTab("角色信息", new ImageIcon(getClass().getResource("/gui/1.png")), 角色信息1); // NOI18N
        ...
        角色背包穿戴.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        角色装备背包.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        角色消耗背包.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        角色设置背包.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        角色其他背包.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        角色特殊背包.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        角色游戏仓库.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        角色商城仓库.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        角色点券拍卖行.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        角色金币拍卖行.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        jTabbedPane8.addTab("角色道具信息", new ImageIcon(getClass().getResource("/gui/1.png")), 角色背包); // NOI18N
        ...
        技能信息.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        jTabbedPane8.addTab("角色技能信息", new ImageIcon(getClass().getResource("/gui/1.png")), 技能); // NOI18N

        jPanel50.setBackground(new java.awt.Color(255, 255, 255));

        家族信息.setFont(new java.awt.Font("幼圆", 0, 15)); // NOI18N
        家族信息.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        jTabbedPane8.addTab("游戏家族", new ImageIcon(getClass().getResource("/gui/1.png")), jPanel50); // NOI18N
        ...
        封IP.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        封MAC.setModel(new DefaultTableModel(
            new Object [][] {
        ...
        jTabbedPane8.addTab("MAC/IP封禁", new ImageIcon(getClass().getResource("/gui/1.png")), jPanel65); // NOI18N
