...
public class PlayerInteractionHandler
{
    ...
    public static byte INVITE_TRADE = 2;
    public static byte DENY_TRADE = 3;
    public static byte VISIT = 4;
    public static byte CHAT = 6;
    public static byte EXIT = 10;
    public static byte OPEN = 11;
    public static byte CASH_ITEM_INTER = 13;
    public static byte SET_ITEMS = 14;
    public static byte SET_MESO = 15;
    public static byte CONFIRM_TRADE = 16;
    public static byte TRADE_SOMETHING = 18;
    public static byte PLAYER_SHOP_ADD_ITEM = 20;
    public static byte BUY_ITEM_PLAYER_SHOP = 21;
    public static byte KICK_Player = 26;
    public static byte MERCHANT_EXIT = 27;
    public static byte ADD_ITEM = 31;
    public static byte BUY_ITEM_STORE = 32;
    public static byte BUY_ITEM_HIREDMERCHANT = 33;
    public static byte REMOVE_ITEM = 35;
    public static byte REMOVE_ITEM_PS = 36;
    public static byte MAINTANCE_OFF = 37;
    public static byte MAINTANCE_ORGANISE = 38;
    public static byte CLOSE_MERCHANT = 39;
    public static byte ADMIN_STORE_NAMECHANGE = 43;
    public static byte VIEW_MERCHANT_VISITOR = 44;
    public static byte VIEW_MERCHANT_BLACKLIST = 45;
    public static byte MERCHANT_BLACKLIST_ADD = 46;
    public static byte MERCHANT_BLACKLIST_REMOVE = 47;
    public static byte REQUEST_TIE = 48;
    public static byte ANSWER_TIE = 49;
    public static byte GIVE_UP = 50;
    public static byte REQUEST_REDO = 53;
    public static byte ANSWER_REDO = 54;
    public static byte EXIT_AFTER_GAME = 55;
    public static byte CANCEL_EXIT = 56;
    public static byte READY = 57;
    public static byte UN_READY = 58;
    public static byte EXPEL = 59;
    public static byte START = 60;
