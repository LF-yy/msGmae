...
public class MovementParse
{
    ...
    public static final List<LifeMovementFragment> parseMovement吸怪(final LittleEndianAccessor lea,final UserAttraction userAttraction) {
        ...
        for (byte i = 0; i < numCommands; ++i) {
            ...
            switch (command) {
                ...
                case 17: {
                    ...
                    final StaticLifeMovement mov = new StaticLifeMovement((int)command, userAttraction.getPosition(), (int)duration, (int)newstate, (int)unk);
                    mov.setUnk(unk);
                    mov.setFh(fh);
                ...
                case 11: {
                    ...
                    final StaticLifeMovement mov3 = new StaticLifeMovement((int)command, null, 0, (int)newstate3, 0);
                    mov3.setUnk(unk2);
                    res.add(mov3);
                    break;
                }
