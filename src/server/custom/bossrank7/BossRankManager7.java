...
public class BossRankManager7
{
    ...
    public Map<String, BossRankInfo7> getInfoMap(final int cid) {
        final Map<String, BossRankInfo7> info_map = new HashMap<String, BossRankInfo7>();
        ...
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                final BossRankInfo7 info = new BossRankInfo7();
            ...
            try {
                ...
                Logger.getLogger(BossRankManager7.class.getName()).log(Level.SEVERE, null, (Throwable)ex);
            }
        }
        finally {
            try {
                ...
                Logger.getLogger(BossRankManager7.class.getName()).log(Level.SEVERE, null, (Throwable)ex2);
            }
        }
        return info_map;
    }
    
    public BossRankInfo7 getInfo(final int cid, final String bossname) {
    ...
    public int setLog(final int cid, final String cname, final String bossname, final byte type, final int update) {
        int ret = -1;
        BossRankInfo7 info = this.getInfo(cid, bossname);
        boolean add = false;
    ...
    public void update(final BossRankInfo7 info) {
        if (info == null) {
            return;
        }
        Connection con1 = DatabaseConnection.getConnection();
    ...
    public void add(final BossRankInfo7 info) {
        if (info == null) {
            return;
        }
        Connection con1 = DatabaseConnection.getConnection();
    ...
    public List<BossRankInfo7> getRank(final String bossname, final int type) {
        final List<BossRankInfo7> list = new LinkedList<BossRankInfo7>();
    ...
    {
        public static BossRankManager7 instance;
        
        static {
            instance = new BossRankManager7();
        }
    }
}
