...
public class BossRankManager10
{
    ...
    public Map<String, BossRankInfo10> getInfoMap(final int cid) {
        ...
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()) {
                final BossRankInfo10 info = new BossRankInfo10();
            ...
            try {
                ...
                Logger.getLogger(BossRankManager10.class.getName()).log(Level.SEVERE, null, (Throwable)ex);
            }
        }
        finally {
            try {
                ...
                Logger.getLogger(BossRankManager10.class.getName()).log(Level.SEVERE, null, (Throwable)ex2);
            }
        }
        return info_map;
    }
    ...
    public int setLog(final int cid, final String cname, final String bossname, final byte type, final int update) {
        int ret = -1;
        BossRankInfo10 info = this.getInfo(cid, bossname);
        boolean add = false;
    ...
    public void update(final BossRankInfo10 info) {
        if (info == null) {
            return;
        }
        Connection con1 = DatabaseConnection.getConnection();
    ...
    public void add(final BossRankInfo10 info) {
        if (info == null) {
            return;
        }
        Connection con1 = DatabaseConnection.getConnection();
