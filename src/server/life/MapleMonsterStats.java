...
public class MapleMonsterStats
{
    ...
    public ElementalEffectiveness getEffectiveness(final Element e) {
        final ElementalEffectiveness elementalEffectiveness = (ElementalEffectiveness)this.resistance.get((Object)e);
    ...
    public boolean hasSkill(final int skillId, final int level) {
        for (final Pair<Integer, Integer> skill : this.skills) {
            if ((int)Integer.valueOf(skill.getLeft()) == skillId && (int)Integer.valueOf(skill.getRight()) == level) {
                return true;
            }
        }
        return false;
