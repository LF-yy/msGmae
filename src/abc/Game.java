...
public class Game
{
    ...
    static {
        ...
        Game.商城端口 = 8600;
        Game.作者QQ = "476215166";//一级作者849340706
        Game.作者昵称 = "CongMs";
        Game.官方群号 = "750545564";
        Game.人数限制 = 999;
        Game.官方群链接 = "http://www.baidu.com";
        Game.IP地址 = "49.235.185.245";//神昱岛:118.89.171.14  171.115.220.33   118.25.187.104   风行岛   111.229.164.192  127.0.0.1    测试 49.235.185.245    桃花岛: 61.147.96.66
        ...
        Game.NPC前缀 = "cm";
        Game.NPC前缀2 = "MMP";
        Game.ZEVMS官网 = "http://www.baidu.com";
