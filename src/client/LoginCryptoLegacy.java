...
public class LoginCryptoLegacy
{
    ...
    private static String myCrypt(final String password, String seed) throws RuntimeException {
        String out = null;
        int count = 8;
        if (!seed.substring(0, 3).equals((Object)"$H$")) {
            final byte[] randomBytes = new byte[6];
            LoginCryptoLegacy.rand.nextBytes(randomBytes);
        ...
        try {
            ...
            do {
                ...
                System.arraycopy((Object)sha1Hash, 0, (Object)CombinedBytes, 0, sha1Hash.length);
                System.arraycopy((Object)password.getBytes("iso-8859-1"), 0, (Object)CombinedBytes, sha1Hash.length, password.getBytes("iso-8859-1").length);
            ...
            System.err.println("Error hashing password." + (Object)ex2);
        }
        if (out == null) {
