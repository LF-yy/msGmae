...
public class FileoutputUtil
{
    ...
    public static String Acc_Stuck = "logs/Except/Log_AccountStuck.txt";
    public static String Login_Error = "logs\\Log_Login_Error.txt";
    public static String IP_Log = "logs\\Log_AccountIP.txt";
    public static String GMCommand_Log = "logs\\Log_GMCommand.txt";
    public static String UnknownPacket_Log = "logs\\数据包_未知.txt";
    public static String Packet_Log = "logs\\数据包收發\\Log.txt";
    public static String Pinkbean_Log = "logs\\Log_Pinkbean.rtf";
    public static String ScriptEx_Log = "logs\\Log_Script_Except.txt";
    public static String PacketEx_Log = "logs/Except/Log_Packet_Except.txt";
    public static String CodeEx_Log = "logs/Except/Log_Code_Except.txt";
