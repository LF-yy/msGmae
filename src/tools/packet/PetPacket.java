...
public class PetPacket
{
    ...
    public static byte[] updatePet(final MaplePet pet, final IItem item) {
    ...
    public static byte[] removePet(MapleCharacter chr, final int slot) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static byte[] showPet(MapleCharacter chr, final MaplePet pet, final boolean remove, final boolean hunger) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort((int)SendPacketOpcode.SPAWN_PET.getValue());
        mplew.writeInt(chr.getId());
    ...
    public static byte[] showPetLevelUp(MapleCharacter chr, final byte index) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static byte[] emptyStatUpdate() {
        return MaplePacketCreator.enableActions();
    }
    
    public static byte[] petStatUpdate_Empty() {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static byte[] loadExceptionList(MapleCharacter chr, final MaplePet pet) {
        final MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
